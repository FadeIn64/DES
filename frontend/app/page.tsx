          ...
          <CardHeader className="pb-3">
            <div className="flex items-start justify-between">
              <div className="space-y-1 flex-1">
                ...
                <CardDescription className="text-base line-clamp-2">{meeting.description}</CardDescription>
              </div>
    ...
    return (
        <div className="container mx-auto py-10">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-4xl md:text-5xl font-bold mb-2">Гонки Формулы-1</h1>
          ...
          <div className="mb-8">
            <div className="flex flex-col sm:flex-row gap-4 items-start">
              <div>
                <label className="text-base font-medium text-slate-700 dark:text-slate-300 mb-2 block">
                  Фильтр по году:
                </label>
