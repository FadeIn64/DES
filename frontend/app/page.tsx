...
import { Calendar, MapPin, Flag, Radio } from "lucide-react"
          ...
          <div className="flex items-start justify-between">
            <div className="space-y-1 flex-1">
              <div className="flex items-center gap-2 flex-wrap">
                <CardTitle className="text-lg group-hover:text-red-600 transition-colors">{meeting.name}</CardTitle>
      ...
      <div className="container mx-auto py-10">
        <div className="mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-start">
            <div>
              <label className="text-sm font-medium text-slate-700 mb-2 block">Фильтр по году:</label>
              <YearFilter availableYears={availableYears} selectedYear={selectedYear} />
            </div>
            <div>
              <label className="text-sm font-medium text-slate-700 mb-2 block">Сортировка по дате:</label>
